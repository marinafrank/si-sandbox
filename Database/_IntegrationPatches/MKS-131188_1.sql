...
-- FraBe 06.03.2014 creation due to MKS-131188:1 get_dealer_CoPartnerAssignment: neue  - IN parameter
...
-- $CompanyInfo $
--
-- $Date: 2014/03/15 09:01:46MEZ $
--
-- $Name: CBL_PreInt4 CBL_Wave3.2 CBL_WavePI2_Partner+Vertrag  $
--
-- $Revision: 1.1 $
--
-- $Header: 5100_Code_Base/Database/_IntegrationPatches/MKS-131188_1.sql 1.1 2014/03/15 09:01:46MEZ Berger, Franz (fraberg) CI_Changed  $
--
-- $Source: 5100_Code_Base/Database/_IntegrationPatches/MKS-131188_1.sql $
--
-- $Log: 5100_Code_Base/Database/_IntegrationPatches/MKS-131188_1.sql  $
-- Revision 1.1 2014/03/15 09:01:46MEZ Berger, Franz (fraberg) 
-- Initial revision
   ...
   IS
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           ...
                           , XMLCOMMENT ( 'related to CIM: 20140221_CIM_EDF_PhysicalPerson(privateCustomer)_Mig_BEL_Wave3_2_iter1_v1.0_.xlsx' )
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           , xmlattributes ( 'http://common.icon.daimler.com/il'          as "xmlns:common"
                                           , 'http://www.w3.org/2001/XMLSchema-instance'  as "xmlns:xsi"
                                           , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                           , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_PhysicalPerson(contactPerson)_Mig_BEL_Wave3_2_iter1_v1.0_.xlsx' )
                           , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                           , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                           , XMLELEMENT ( "executionSettings"
                                , xmlattributes
         ...
         BEGIN
            ...
            select XMLELEMENT ( "common:ServiceInvocationCollection"
                              , xmlattributes ( 'http://common.icon.daimler.com/il'          as "xmlns:common"
                                              , 'http://www.w3.org/2001/XMLSchema-instance'  as "xmlns:xsi"
                                              , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                              , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_OrganisationalPerson(commercialCustomer)_Mig_BEL_Wave3_2_iter1_v1.0.xlsx' )
                              , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                              , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                              , XMLELEMENT ( "executionSettings"
                                   , xmlattributes
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           , xmlattributes ( 'http://common.icon.daimler.com/il'          as "xmlns:common"
                                           , 'http://www.w3.org/2001/XMLSchema-instance'  as "xmlns:xsi"
                                           , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                           , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_OrganisationalPerson(workshop)_Mig_BEL_Wave3_2_iter1_v1.0.xlsx' )
                           , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                           , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                           , XMLELEMENT ( "executionSettings"
                                , xmlattributes
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           , xmlattributes ( 'http://common.icon.daimler.com/il'          as "xmlns:common"
                                           , 'http://www.w3.org/2001/XMLSchema-instance'  as "xmlns:xsi"
                                           , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                           , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_OrganisationalPerson(supplier)_Mig_BEL_Wave3_2_iter1_v1.0.xlsx' )
                           , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                           , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                           , XMLELEMENT ( "executionSettings"
                                , xmlattributes
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           , xmlattributes ( 'http://common.icon.daimler.com/il'          AS "xmlns:common"
                                           , 'http://www.w3.org/2001/XMLSchema-instance'  AS "xmlns:xsi"
                                           , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                           , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_PhysicalPerson(salesman)_Mig_BEL_Wave3_2_iter1_v1.0_.xlsx' )
                           , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                           , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                           , XMLELEMENT ( "executionSettings"
                                , xmlattributes
      ...
      BEGIN
         ...
         select XMLELEMENT ( "common:ServiceInvocationCollection"
                           , xmlattributes ( 'http://common.icon.daimler.com/il'          as "xmlns:common"
                                           , 'http://www.w3.org/2001/XMLSchema-instance'  as "xmlns:xsi"
                                           , 'http://www.w3.org/2001/XMLSchema'           as "xmlns:xsd" )
                           , XMLCOMMENT ( 'Related to CIM: 20140221_CIM_EDF_OrganisationalPerson(dealer)_Mig_BEL_Wave3_2_iter1_v1.0.xlsx' )
                           , XMLCOMMENT ( 'Related to Masterdata:' || L_masterDataVersion )
                           , XMLCOMMENT ( 'Source-database: '      || L_DB_NAME_of_DB_LINK )
                           , XMLELEMENT ( "executionSettings"
                                , xmlattributes
                                                  ...
                                                  , xmlattributes ( 'createOrganisationalPerson' as "operation"  )
                                                      , XMLELEMENT ( "parameter"
                                                           ...
                                                           , pck_partner.get_dealer_CoPartnerAssignment ( gar.ID_GARAGE
                                                                                                        , L_SourceSystem
                                                                                                        , i_TAS_GUID
                                                                                                        , L_TIMESTAMP )           as "contactPartnerAssignment"
                                                        /* , XMLELEMENT ( "costIssuer"
                                                                , xmlattributes ( PCK_CALCULATION.SUBSTITUTE ( i_TAS_GUID
                                                                                                             , L_TIMESTAMP
                                                                                                             , 'CUR_CODE'
...
insert into simex.TSUBSTITUTE ( SUB_GUID,                           SUB_SRS_ATT_NAME, SUB_SRS_ATT_VALUE, SUB_ICO_ATT_VALUE, SUB_DEFAULT )
                       values ( '3EC8651708C84F31BE65F9DF4F6C32AD', 'contactRole',    'salesman',        NULL,              1           );