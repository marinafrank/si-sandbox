...
Spools workshops with empty SAP Debtior Nr.
...
Step 4:  SQL > @show_workshops_with_empty_SAP_DEBITOR.sql

Step 7:  check the generated log file 
         show_workshops_with_empty_SAP_DEBITOR.log in your working folder.
