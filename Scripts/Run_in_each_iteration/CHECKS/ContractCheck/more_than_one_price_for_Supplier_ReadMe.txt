===========================================================================
= SIRIUS Service-Script for MKS-121109                                    =
===========================================================================
...
Preconditions: 
1) store  more_than_one_price_for_Supplier.sql into your working directory
...
checks if there exists a ServiceProvider supplier contract with more than 1 price value
...
Step  4: SQL> @ more_than_one_price_for_Supplier.sql

Step  5: does action as described in Description above
         The output can be found in the created logfile  more_than_one_price_for_Supplier.log

Step  6: When script has finished: 
         check the generated logfile  more_than_one_price_for_Supplier.log if any ORA- or SP2- error has occured.
