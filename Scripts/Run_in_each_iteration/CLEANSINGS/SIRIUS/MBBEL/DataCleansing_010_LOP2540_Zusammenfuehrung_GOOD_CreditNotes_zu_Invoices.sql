-- DataCleansing_LOP2540_-_Zusammenfuehrung_GOOD_CreditNotes_zu_Invoices.sql
...
-- 2014-05-06; ZBerger; V1.1; MKS-132527:1; DataCleansing LOP2540 - Zusammenführung GOOD CreditNotes zu Invoices
-- 2014-05-12; ZBerger; V1.3; MKS-132527:3; Add counting of L_DATAWARNINGS_OCCURED
...
--
   ...
   define GL_SCRIPTNAME		= DataCleansing_010_LOP2540_-_Zusammenfuehrung_GOOD_CreditNotes_zu_Invoices
...
-- 1st: 
prompt 
prompt Correct references:
prompt 

declare

procedure upd_tfzgrechnung(i_id_seq_fzgrechnung    snt.tfzgrechnung.id_seq_fzgrechnung%type,
                           i_fzgre_referenzbuchung snt.tfzgrechnung.fzgre_referenzbuchung%type) is
begin

   update snt.tfzgrechnung
      set fzgre_referenzbuchung = i_fzgre_referenzbuchung
    where id_seq_fzgrechnung    = i_id_seq_fzgrechnung;

   if sql%rowcount > 0 then
     dbms_output.put_line ( 'CN ' || i_id_seq_fzgrechnung || ' successfully updated!');
      :L_DATASUCCESS_OCCURED := :L_DATASUCCESS_OCCURED +1;
   else
     dbms_output.put_line ('CN ' || i_id_seq_fzgrechnung || ' not found!' );
...
end upd_tfzgrechnung;

begin
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>246627, I_FZGRE_REFERENZBUCHUNG=>246626);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>614096, I_FZGRE_REFERENZBUCHUNG=>334033);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>332975, I_FZGRE_REFERENZBUCHUNG=>305607);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>644254, I_FZGRE_REFERENZBUCHUNG=>642778);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>596335, I_FZGRE_REFERENZBUCHUNG=>578262);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>588606, I_FZGRE_REFERENZBUCHUNG=>559711);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>640362, I_FZGRE_REFERENZBUCHUNG=>631535);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>596884, I_FZGRE_REFERENZBUCHUNG=>590941);
   upd_tfzgrechnung(I_ID_SEQ_FZGRECHNUNG=>595379, I_FZGRE_REFERENZBUCHUNG=>595377);
