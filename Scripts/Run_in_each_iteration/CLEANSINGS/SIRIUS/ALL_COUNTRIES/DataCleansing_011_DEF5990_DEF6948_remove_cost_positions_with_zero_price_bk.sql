...
DECLARE
   ...
   CURSOR costwopos
   IS
      SELECT distinct id_seq_fzgrechnung, id_imp_type
...
BEGIN
   ...
   LOOP
      BEGIN
         DELETE FROM tinv_position
               WHERE guid_ip = rcur.guid_ip;
   ...
   FOR rcur IN costwopos
   LOOP
      BEGIN
         update tfzgrechnung set id_belegart = l_infotype where id_seq_fzgrechnung = rcur.id_seq_fzgrechnung ;
