...
Preconditions: 
1) store DataCleansing_LOP2146_DEF8914-CleanCustomerDuplicates4.sql into your working directory
...
Step  5: SQL> @DataCleansing_LOP2146_DEF8914-CleanCustomerDuplicates4.sql
...
Step  7: Changes data.
         The output can be found in the created logfile DataCleansing_LOP2146_DEF8914-CleanCustomerDuplicates4.log

Step  8: When script has finished: 
         check the generated logfile DataCleansing_LOP2146_DEF8914-CleanCustomerDuplicates4.log if any ORA- or 
         SP2- error has occured. In case of data warnings or data errors, please check the logfile in detail.

         If there are unfixable errors, please contact the SIRIUS technical support team @Ulm. 
