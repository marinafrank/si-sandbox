...
Date         : 05.02.2014
Author       : CPauzenberger

Preconditions: 
1) store DataCleansing_LOP2259-MapCampaigns_II.sql into your working directory
...
Step  5: SQL> @DataCleansing_LOP2259-MapCampaigns_II.sql
...
Step  7: Does the changes described above.
         The output can be found in the created logfile DataCleansing_LOP2259-MapCampaigns_II.log

Step  8: When script has finished: 
         check the generated logfile DataCleansing_LOP2259-MapCampaigns_II.log if any ORA- or SP2- error has occured.
