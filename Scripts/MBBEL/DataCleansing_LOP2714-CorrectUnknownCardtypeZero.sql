-- DataCleansing_LOP2714-CorrectUnknownCardtypeZero.sql
-- <Autor>     28.02.2014 MKS-131544:1 / LOP2714

spool DataCleansing_LOP2714-CorrectUnknownCardtypeZero.log
...
exec :L_SCRIPTNAME       := 'DataCleansing_LOP2714-CorrectUnknownCardtypeZero.sql';
...
prompt 
prompt SIRIUS Invoice number 80869:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 80869;


prompt 
prompt SIRIUS Invoice number 211799:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 211799;


prompt 
prompt SIRIUS Invoice number 301044:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 301044;


prompt 
prompt SIRIUS Invoice number 360374:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 360374;


prompt 
prompt SIRIUS Invoice number 326049:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 326049;


prompt 
prompt SIRIUS Invoice number 350333:
prompt 
update snt.TINV_POSITION set IP_CARDTYPE = 13 where IP_CARDTYPE = 0 and ID_SEQ_FZGRECHNUNG = 350333;
...
prompt
prompt please contact the SIRIUS support team in Ulm if any ORA- or SP2- error is listed in the logfile DataCleansing_LOP2714-CorrectUnknownCardtypeZero.log
prompt
