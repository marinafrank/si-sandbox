-- DataCleansing_LOP2857-RemoveWorkshops.sql
-- CPauzen     05.02.2014 MKS-130861:1 LOP2857
-- CPauzen     12.02.2014 MKS-130861:2 LOP2857

spool DataCleansing_LOP2857-RemoveWorkshops.log
...
exec :L_SCRIPTNAME       := 'DataCleansing_LOP2857-RemoveWorkshops.sql';
...
alter table snt.tpartner modify constraint GAR_ID_PARTNER disable;
alter table snt.tgarage  modify constraint ADRASS_ID_GAR disable;
...
-- 1st: 
set echo         on
update snt.tfzgvertrag set id_garage_serv = 0 where id_garage_serv = 2003;
delete from snt.tpartner  where id_garage in (2003,5507,12115);
delete from snt.tadrassoz where id_seq_adrassoz in (select id_seq_adrassoz from snt.tgarage where id_garage in (2003,5507,12115));
delete from snt.tgarage   where id_garage in (2003,5507,12115);
set echo         off
...
alter table snt.tpartner modify constraint GAR_ID_PARTNER enable validate;
alter table snt.tgarage  modify constraint ADRASS_ID_GAR enable validate;
...
prompt
prompt please contact the SIRIUS support team in Ulm if any ORA- or SP2- error is listed in the logfile DataCleansing_LOP2857-RemoveWorkshops.log
prompt
