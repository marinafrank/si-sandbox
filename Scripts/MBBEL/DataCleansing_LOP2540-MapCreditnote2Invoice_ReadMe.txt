===========================================================================
= SIRIUS Service-Script for LOP2540 / LOP2543                             =
===========================================================================

Date         : 02.09.2013 / 23.09.2013
Author       : M. Zimmerberger / FraBe

Preconditions: 
1) store DataCleansing_LOP2540-MapCreditnote2Invoice.sql into your working directory
...
updates tfzgrechnung.fzgre_referenzbuchung as given in MKS-127508 / 128303
...
Step  5: SQL> @DataCleansing_LOP2540-MapCreditnote2Invoice.sql
...
Step  7: does action described above
         The output can be found in the created logfile DataCleansing_LOP2540-MapCreditnote2Invoice.log

Step  8: When script has finished: 
         check the generated logfile DataCleansing_LOP2540-MapCreditnote2Invoice.log if any ORA- or SP2- error has occured.
