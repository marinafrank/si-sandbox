===========================================================================
= SIRIUS Service-Script for iCON Ticket LOP2720                           =
===========================================================================
...
Preconditions: 
1) store DataCleansing_LOP2720-Remove1stPeriodOfContract015806-0003.sql into your working directory
...
a) moves some data of the 1st duration of contract 015806/0003 to the 2nd duration
b) deletes the 1st duration of contract 015806/0003
...
Step  5: SQL> @DataCleansing_LOP2720-Remove1stPeriodOfContract015806-0003.sql
...
Step  6: Answer Y or N within question: Do you want to save the changes to the DB?
         ...
         Please note: 'Y' saves data into the DB only if everything finishes successful.
         If at least one error occurs, no data will be saved into the DB - even if the answer is 'Y'.

Step  7: does action described above.
         The output can be found in the created logfile DataCleansing_LOP2720-Remove1stPeriodOfContract015806-0003.log

Step  8: When script has finished: 
         check the generated logfile DataCleansing_LOP2720-Remove1stPeriodOfContract015806-0003.log if any ORA- or SP2- error has occured.
