...
Preconditions: 
1) store DataCleansing_LOP2146_DEF7571-CleanCustomerDuplicates3.sql into your working directory
...
Step  5: SQL> @DataCleansing_LOP2146_DEF7571-CleanCustomerDuplicates3.sql
...
Step  7: Changes data.
         The output can be found in the created logfile DataCleansing_LOP2146_DEF7571-CleanCustomerDuplicates3.log

Step  8: When script has finished: 
         check the generated logfile DataCleansing_LOP2146_DEF7571-CleanCustomerDuplicates3.log if any ORA- or 
