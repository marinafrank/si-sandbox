-- DataAnalysis_CountOfRevenuesOfCustomerZero.sql
-- CHANGE 126297 LOP2259 - Migration Customer Invoice BEL
-- cpauzen 26.06.2013 MKS-126297:1 creation 
-- zisco   04.07.2013 MKS-126297:2 add scoping-logic
-- FraBe   22.07.2013 MKS-126297:3 remove durchführung select ein zweites mal / standard ScriptHeader hinzuegefügt

spool DataAnalysis_CountOfRevenuesOfCustomerZero.lst
...
exec :L_SCRIPTNAME      := 'DataAnalysis_CountOfRevenuesOfCustomerZero.sql';
...
set feedback  1
  ...
  SELECT   par.id_customer,
   ...
   WHERE ( par.id_customer        = '0' 
        OR par.id_customer        = '00000000000' )
      AND  par.guid_partner       = ci.guid_partner
      AND  ci.id_seq_fzgvc        = fzgv.id_seq_fzgvc
      AND  fzgv.id_cov            = cov.id_cov
      AND  cov.cov_caption NOT LIKE '%MIG_OOS%'
ORDER BY   ci_document_number, ci_date;
...
prompt
prompt please contact the SIRIUS support team in Ulm if any ORA- or SP2- error is listed in the logfile DataAnalysis_CountOfRevenuesOfCustomerZero.lst
prompt
