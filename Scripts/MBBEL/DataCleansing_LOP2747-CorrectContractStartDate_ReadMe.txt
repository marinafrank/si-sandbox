===========================================================================
= SIRIUS Data Cleansing Script for LOP2747                                =
===========================================================================

Date         : 11.09.2013 / 24.09.2013
Author       : FraBe

Preconditions: 
1) store DataCleansing_LOP2747-CorrectContractStartDate.sql into your working directory
...
changes the contract begin date of some contracts given by the MPC
...
Step  5: SQL> @DataCleansing_LOP2747-CorrectContractStartDate.sql
...
Step  6: Answer Y or N within question: Do you want to save the changes to the DB?
         ...
         Please note: 'Y' saves data into the DB only if the start date of ALL contracts can be fixed.
         If at least one cannot be fixed, no data will be saved into the DB even if the answer is 'Y'.

Step  7: Does the changes described above.
         The output can be found in the created logfile DataCleansing_LOP2747-CorrectContractStartDate.log

Step  8: When script has finished check the generated logfile DataCleansing_LOP2747-CorrectContractStartDate.log 
         if any ORA- or SP2- error or the message 'The begin date of CO ... could not be changed' has occured.
