-- DataCleansing_LOP2259-MapCampaigns.sql

-- FraBe   11.09.2013 MKS-128301:1 / LOP2259: creation

spool DataCleansing_LOP2259-MapCampaigns.log
...
exec :L_SCRIPTNAME       := 'DataCleansing_LOP2259-MapCampaigns.sql';
...
prompt
prompt please contact the SIRIUS support team in Ulm if any ORA- or SP2- error is listed in the logfile DataCleansing_LOP2259-MapCampaigns.log
prompt
